...
values. The system section uses the versioned `MONITOR_V6` tab-separated protocol and
retains read compatibility with `MONITOR_V5` and `MONITOR_V4`. NVIDIA device and
